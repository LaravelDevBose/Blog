...
@section('content')
    ...
    <div class="content">
        ...
        <form action="{{ route('notice.update') }}" method="POST" name="notice_edit" enctype="multipart/form-data"> {{csrf_field()}}
            <div class="row">
                <div class=" col-lg-12">
                    <!-- Form validation -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="content-group">
                                        ...
                                        <input type="text" name="notice_title" value="{{ $notice->notice_title }}" required class="form-control maxlength-options" maxlength="70" placeholder="Enter Your Notice Title...">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="notice_content"  class="summernote-height" maxlength="2500" placeholder="Enter Your Notice Details.....">{!! $notice->notice_content !!}</textarea>
                            ...
                            <div class="col-sm-6 col-md-12 col-lg-12">
                                <div class="text-right">
                                    <button type="submit"  class="btn btn-success btn-block data-check" data-toggle="modal" data-target="#confirm_modal">Update Notice<i class="icon-arrow-right14 position-right"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.forms['notice_edit'].elements['priority'].value={{ $notice->priority }}
        document.forms['notice_edit'].elements['status'].value={{ $notice->status }}
    </script>
@endsection