					...
					<div class="panel-body">
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-7">
									<label class="control-label fullName">{{ Auth::User()->name }}</label>
								</div>

								<div class="col-lg-2">
									<label class="text-info" title="Edit" onclick="viewToggle('fullName')"> <i class="icon-pencil5"></i></label>
								</div>
								
							</div>
							
							<div class="row" id="fullName" style="display: none;">
								<div class="col-lg-offset-3" >
									...
									<div class="col-lg-2 col-lg-offset-2">
										<button type="submit"  class="btn btn-primary fullName_submit">Submit</button>
									</div>
								</div>
							</div>
							<hr>
						...
						<div class="form-group">
							...
							<div class="row" id="avater" style="display: none;">
								<div class="col-lg-offset-3" >
									<form  action="{{ route('avater') }}" method="post" enctype="multipart/form-data">
										{{ csrf_field()}}
										<div class="col-lg-7 ">
						...
						<div class="form-group">
							...
							<div class="row" id="bio" style="display: none;">
								<div class="col-lg-offset-3" >
									...
									<div class="col-lg-2 ">
										<button type="submit" class="btn btn-primary bio_submit">Submit</button>
									</div>
								</div>
							</div>
							<hr>
						...
						<div class="form-group">
							...
							<div class="row" id="phoneNo" style="display: none;">
								<div class="col-lg-offset-3" >
									...
									<div class="col-lg-2 col-lg-offset-2">
										<button type="submit" class="btn btn-primary phoneNo_submit">Submit</button>
									</div>
								</div>
							</div>
							<hr>
						...
						<div class="form-group">
							...
							<div class="row" id="password" style="display: none;">
								<div class="col-lg-offset-3">
									...
									<div class="col-lg-2 col-lg-offset-2">
										<button type="submit" class="btn btn-primary password_submit">Submit</button>
									</div>
								</div>
							</div>
							<hr>
